...
router.get(
    ...
    (req, res) => {
        // Include 'username' and 'profilePic' in the JWT payload
        ...
        res.cookie('jwt', token); // Store the JWT in cookies
        res.redirect(process.env.CLIENT_URL); // Redirect to the specified client URL
    }
);
